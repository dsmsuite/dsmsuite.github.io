            ...
            <xs:sequence>
              <xs:element minOccurs="0" maxOccurs="unbounded" name="element">
                <xs:complexType>
                  ...
                  <xs:attribute name="name"     type="xs:string"  use="required" />
                  <xs:attribute name="type"     type="xs:string"  use="optional" />
                  <xs:attribute name="nested"   type="xs:string"  use="required" />				  
          ...
          <xs:complexType>
            <xs:sequence>
              <xs:element minOccurs="0" maxOccurs="unbounded" name="relation">
                <xs:complexType>
                  <xs:attribute name="provider" type="xs:integer" use="required" />
                  <xs:attribute name="consumer" type="xs:integer" use="required" />
                  <xs:attribute name="type"     type="xs:string"  use="optional" />
